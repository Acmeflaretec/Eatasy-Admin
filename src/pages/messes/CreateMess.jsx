...
import { useAddMess } from 'api/queries/messQuery';
...
const CreateMess = () => {
   ...
   const { mutateAsync: addMess, isLoading } = useAddMess()
   ...
   return (
      <MainCard title="Create Mess" action={<Button variant='contained' onClick={() => navigate('/messes/create')}><PlusOutlined />{" "} Create</Button>}>
